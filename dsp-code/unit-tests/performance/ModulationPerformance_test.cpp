...
TEST(ModulationPerformanceTest, performance)
{
    ...
    std::cout << "ModulationPerformanceTest.performance: " << msecs << " ms ";
...
TEST(ModulationPerformanceTest, compareOptimized)
{
    ...
    class SUTOptimized
    {
      ...
      private:
        DSP::SlowSineLfoOptimized<float> sut;
        std::array<float, 1024> m_data{};
        size_t m_samplesProcessed{0};
    };
